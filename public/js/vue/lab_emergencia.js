const lab_consulta_externa = new Vue({
    ...
    methods:{  
        ...
        list_ecografias_data(){
            ...
            this.list_rayosX = false
            this.lis_lab = false
            fetch(this.url+'/laboratorios/list_ecografias_emg/'+this.historial+'/'+this.id_consulta)
            .then(res => res.json())
            .catch(error => console.error('Error:', error))
            .then(data => {
        ...
        register_ecografia(e){
            ...
            fetch(this.url+'/laboratorios/vue_insert_lab_consulta_emg/'+this.id_consulta,esto)
            .then(res => res.json())
            .catch(error => console.error('Error:', error))
            .then(data => {
        ...
        list_rayosX_data(){
            ...
            this.lis_lab = false
            fetch(this.url+'/laboratorios/list_rayosX_emg/'+this.historial+'/'+this.id_consulta)
            .then(res => res.json())
            .catch(error => console.error('Error:', error))
            .then(data => {
        ...
        list_lab_data(){
            ...
            this.list_rayosX = false
            this.lis_lab = true
            fetch(this.url+'/laboratorios/list_laboratorios_emg/'+this.historial+'/'+this.id_consulta)
            .then(res => res.json())
            .catch(error => console.error('Error:', error))
            .then(data => {
